...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-slate-700 hover:bg-slate-600 text-white disabled:hover:bg-slate-700',
    danger: 'bg-red-600 hover:bg-red-700 text-white disabled:hover:bg-red-600',
    outline:
      'border border-slate-600 text-slate-100 hover:bg-slate-800/50 disabled:hover:bg-transparent',
  };
